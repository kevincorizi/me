!(function (a, b, c) {
  ...
  function u(b) {
    var c = b || a;
    return { height: c.innerHeight, width: c.innerWidth };
  }
  function v(b, c) {
  ...
  function A(a, b) {
    var c = a.getBoundingClientRect(),
      d = u(b);
    if (!z(c, d) || !y(a)) return 0;
    var e = 0,
      f = 0;
    return c.top >= 0 ? (e = Math.min(c.height, d.height - c.top)) : c.bottom > 0 && (e = Math.min(d.height, c.bottom)), c.left >= 0 ? (f = Math.min(c.width, d.width - c.left)) : c.right > 0 && (f = Math.min(d.width, c.right)), (e * f) / (c.height * c.width);
  }
  function B(b) {
    return !F(b || a).isHidden();
  }
  function C(b, c) {
    if (!(this instanceof C)) return new C(b, c);
    if (!n(b)) throw new Error('not an element node');
    (this._element = b), (this._config = f(c, { fullyvisible: 1, hidden: 0, referenceWindow: a, percentageHook: A, precision: 3, visibilityHooks: [] }));
  ...
  function E(a, b) {
    var c = f(b, { strategy: [new E.Strategy.PollingStrategy(), new E.Strategy.EventStrategy()], async: !1 });
    (this._visobj = a), (this._state = {}), (this._started = !1);
    var d = '*#' + r();
    (this._pubsub = new G({ async: c.async, anyTopicName: d })),
  ...
  var F = function (b) {
            ...
            return a[c.property] !== b
              ? {
                  ...
                  onVisibilityChange: function (b) {
                    return (
                      a.addEventListener(c.event, b, !1),
                      function () {
    ...
    G = (function (a) {
      function b(a) {
        (this._cache = {}), (this._onAnyCache = []), (this._config = f(a, { async: !1, anyTopicName: '*' }));
      }
      var c = function (a, b) {
        j(a, function (a) {
          a(b);
      ...
      return (
        (b.prototype.on = function (b, c) {
          ...
          return b === this._config.anyTopicName ? (this._onAnyCache.push(f), g(f, this._onAnyCache, '*')) : (this._cache[b] || (this._cache[b] = []), this._cache[b].push(f), g(f, this._cache[b], b));
        }),
  ...
  var H = { HIDDEN: [0, 'hidden'], VISIBLE: [1, 'visible'], FULLY_VISIBLE: [2, 'fullyvisible'] };
  return (
    (C.VisState = (function () {
      function a(a, b, c) {
        return c && delete c.previous, { code: a[0], state: a[1], percentage: b, previous: c || {}, fullyvisible: a[0] === H.FULLY_VISIBLE[0], visible: a[0] === H.VISIBLE[0] || a[0] === H.FULLY_VISIBLE[0], hidden: a[0] === H.HIDDEN[0] };
      }
      return {
        hidden: function (b, c) {
    ...
    (E.prototype.publish = function (a, b) {
      ...
      if (c) throw new Error('Cannot publish internal event "' + a + '" from external scope.');
    ...
    (E.prototype.start = function (a) {
      ...
      var b = f(a, { async: !1 });
      return this._cancelAsyncStart && this._cancelAsyncStart(), b.async ? this.startAsync() : ((this._started = !0), this.update(), this._pubsub.publish('start', [this]), this._strategy.start(this), this);
    }),
    (E.prototype.startAsync = function (a) {
      this._cancelAsyncStart && this._cancelAsyncStart();
      var b = this,
        c = g(function () {
          b.start(i(f(a, {}), { async: !1 }));
        });
      return (
    ...
    (E.prototype.update = function () {
      this._started && ((this._state = D(this._visobj, this._state)), this._pubsub.publish('update', [this]));
    }),
    ...
    (E.Strategy.PollingStrategy = function (a) {
      (this._config = f(a, { interval: 1e3 })), (this._started = !1);
    }),
    ...
    (E.Strategy.PollingStrategy.prototype.start = function (a) {
      return (
        this._started ||
          ((this._clearInterval = (function (b) {
    ...
    (E.Strategy.EventStrategy = function (a) {
      (this._config = f(a, { throttle: 50 })), this._config.debounce > 0 && (this._config.throttle = +this._config.debounce), (this._started = !1);
    }),
    (E.Strategy.EventStrategy.prototype = Object.create(E.Strategy.prototype)),
    (E.Strategy.EventStrategy.prototype.start = function (a) {
      return (
        this._started ||
          ((this._removeEventListeners = (function (b) {
            var c = a.visobj().referenceWindow(),
              d = F(c),
              e = d.onVisibilityChange(b);
            return (
              c.addEventListener('scroll', b, !1),
              c.addEventListener('resize', b, !1),
              c.addEventListener('touchmove', b, !1),
              function () {
                c.removeEventListener('touchmove', b, !1), c.removeEventListener('resize', b, !1), c.removeEventListener('scroll', b, !1), e();
              }
            );
          })(
            t(function () {
