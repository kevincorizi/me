      ...
      function (a, b) {
        function c(a, b, c, d) {
          ...
          f.each(a.nodeType ? [a] : a, function (a, b) {
            ...
            'border-box' === e.CSS.getPropertyValue(b, 'boxSizing').toString().toLowerCase() && (i = ['height']),
              f.each(i, function (a, c) {
                h += parseFloat(e.CSS.getPropertyValue(b, c));
              });
          }),
            e.animate(g, { height: ('In' === b ? '+' : '-') + '=' + h }, { queue: !1, easing: 'ease-in-out', duration: c * ('In' === b ? 0.6 : 1) });
        }
        return (
          (e.Redirects[a] = function (d, g, h, i, j, k, l) {
            ...
            for (o = 0; o < b.calls.length; o++) {
              var q = b.calls[o],
                ...
                v = {};
              if (
                (void 0 !== g.duration ? (s = g.duration) : void 0 !== b.defaultDuration && (s = b.defaultDuration),
