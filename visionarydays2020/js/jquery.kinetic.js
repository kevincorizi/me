...
(function ($) {
  ...
  Kinetic.prototype.detach = function () {
    ...
    this.$el.removeClass(ACTIVE_CLASS).css('cursor', '');
  };
  ...
  Kinetic.prototype.attach = function () {
    ...
    this.$el.addClass(ACTIVE_CLASS).css('cursor', this.settings.cursor);
  };
  ...
  Kinetic.prototype._initElements = function () {
    ...
    $(document).mouseup($.proxy(this._resetMouse, this)).click($.proxy(this._resetMouse, this));
  ...
  Kinetic.prototype._setMoveClasses = function (classes) {
    ...
    $this
      .removeClass(settings.movingClass.up)
  ...
  Kinetic.prototype._attachListeners = function () {
    ...
    $this.click(settings.events.inputClick).scroll(settings.events.scroll).bind('selectstart', settings.events.selectStart).bind('dragstart', settings.events.dragStart);
  };
  ...
  Kinetic.prototype._detachListeners = function () {
    ...
    $this.unbind('mousedown', settings.events.inputDown).unbind('mouseup', settings.events.inputEnd).unbind('mousemove', settings.events.inputMove);

    $this.unbind('click', settings.events.inputClick).unbind('scroll', settings.events.scroll).unbind('selectstart', settings.events.selectStart).unbind('dragstart', settings.events.dragStart);
  };
