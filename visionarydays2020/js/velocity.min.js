      ...
      var B = function () {
        ...
        function e(a, e) {
          function f(f) {
                  ...
                  var J = A.Names.camelCase(I),
                    K = (function (b, c) {
                      ...
                      return (
                        ...
                        u.isArray(b)
                          ? ((d = b[0]), (!u.isArray(b[1]) && /^[\d-]/.test(b[1])) || u.isFunction(b[1]) || A.RegEx.isHex.test(b[1]) ? (g = b[1]) : (u.isString(b[1]) && !A.RegEx.isHex.test(b[1]) && y.Easings[b[1]]) || u.isArray(b[1]) ? ((f = c ? b[1] : l(b[1], i.duration)), (g = b[2])) : (g = b[1] || b[2]))
                          : (d = b),
                        c || (f = f || i.easing),
            ...
            j.element &&
              (A.Values.addClass(a, 'velocity-animating'), N.push(j), (k = g(a)), k && ('' === i.queue && ((k.tweensContainer = j), (k.opts = i)), (k.isAnimating = !0)), D === C - 1 ? (y.State.calls.push([N, r, i, null, z.resolver, null, 0]), !1 === y.State.isTicking && ((y.State.isTicking = !0), m())) : D++);
          }
          var h,
